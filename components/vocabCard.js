...
const VocabCard = ({word, type, definition, navigation}) => {
    return (
        <TouchableOpacity style={styles.cardContainer} onPress={() => {navigation.navigate("DictionaryVocabScreen", { word, type, definition })}}>
